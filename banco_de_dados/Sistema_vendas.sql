...
DataAtualizacao DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, -- Ao efetuar uma mudança o update atualiza o campo.
...
Descricao TEXT,
Preco DECIMAL( 10.2) NOT NULL, -- 8 Numeros, 2 depois da virgula
CategoriaID INT,
DataCriacao DATETIME DEFAULT CURRENT_TIMESTAMP,
DataAtualizacao DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, 
UsuarioAtualizacao INT,
